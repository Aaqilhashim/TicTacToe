   ...
   public static void main(String[] args) throws InterruptedException {  
      ...
      while (shouldRestart) {
         ...
         // System.out.println("It is " + nextPlayer(board) + "'s turn:");
            ...
            // printBoard(board);    
               ...
               if (nextPlayer(board).equals("X")) {
                  ...
                  square[nextRow][nextCol].setText("X"); 
                  square[nextRow][nextCol].setEnabled(false);
                  System.out.println("ime taken to make move: " + ((System.nanoTime() - startTime)/1000000) + "ms");                                   
               } else {
                  ...
                  square[nextRow][nextCol].setText("O"); 
                  square[nextRow][nextCol].setEnabled(false);
                  System.out.println("Time taken to make move: " + ((System.nanoTime() - startTime)/1000000) + "ms"); 
               }
               Thread.sleep(500);
            }
         }
         ...
         if (checkWinner(board).equals("Draw")) {
            ...
            JOptionPane.showMessageDialog(null, "Unclucky. X has won", "Game Over", JOptionPane.PLAIN_MESSAGE);
         } else {
            System.out.println("O has won!");
            JOptionPane.showMessageDialog(null, "Unluck. O has won", "Game Over", JOptionPane.PLAIN_MESSAGE);
         }
